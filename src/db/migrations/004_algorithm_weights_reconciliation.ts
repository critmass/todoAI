// AUTO-GENERATED from 004_algorithm_weights_reconciliation.sql - do not hand-edit by hand without
// also updating the .sql source; migrations/__tests__/schemaDrift.test.ts asserts these stay
// byte-identical.
export const MIGRATION_004_SQL = `-- ADHD Task Management App - Schema migration 004 (v2.4 -> v2.5)
