// AUTO-GENERATED from 002_skill_layer_schema.sql - do not hand-edit by hand without also updating
// the .sql source; migrations/__tests__/schemaDrift.test.ts asserts these stay byte-identical.
export const MIGRATION_002_SQL = `-- ADHD Task Management App - Schema migration 002 (v2.2 -> v2.3)
