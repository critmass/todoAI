// AUTO-GENERATED from 008_transitive_cycle_guard.sql - do not hand-edit by hand without also
// updating the .sql source; migrations/__tests__/schemaDrift.test.ts asserts these stay
// byte-identical.
export const MIGRATION_008_SQL = `-- ADHD Task Management App - Schema migration 008 (v2.8 -> v2.9)
