// AUTO-GENERATED from 001_initial_schema.sql - do not hand-edit by hand without also updating
// the .sql source; migrations/__tests__/schema.test.ts asserts these stay byte-identical.
export const MIGRATION_001_SQL = `-- ADHD Task Management App - SQLite Database Schema v2.2
