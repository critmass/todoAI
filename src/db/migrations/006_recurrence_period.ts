// AUTO-GENERATED from 006_recurrence_period.sql - do not hand-edit by hand without also updating
// the .sql source; migrations/__tests__/schemaDrift.test.ts asserts these stay byte-identical.
export const MIGRATION_006_SQL = `-- ADHD Task Management App - Schema migration 006 (v2.6 -> v2.7)
